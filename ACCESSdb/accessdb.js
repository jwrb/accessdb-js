 ...
 * Date: 2009-03-14
 * Revision: 6
 * Modified by Joshua Baldwin to work with OLEDB rather than JET (Access 2003 -> 2007/2010)
 * Date: 2017-01-03
 */
(function() {
    ...
    ACCESSdb = function(dataSrc, options) {
        ...
        this.query = function(query, options) {
            ...
            if (rs.Fields.Count) {
                ...
                rs.close();
                alert("closing connection   -  "  + query)
            }
         else {
            result = false;
         }
        ...
        try {
            this.conn.open("Provider=" + this.provider + ";Data Source=\"" + this.dataSource + "\";Persist Security Info=" + this.options.persist, this.options.user, this.options.password);
